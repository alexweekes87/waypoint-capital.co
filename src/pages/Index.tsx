          ...
          >
            <Collapsible>
              <CollapsibleTrigger className="flex items-center justify-between w-full">
                <h2 className="text-4xl md:text-5xl font-display font-semibold text-center">
                  Who We Are
                </h2>
                <ChevronDown className="h-6 w-6 transition-transform duration-200 collapsible-open:rotate-180" />
              </CollapsibleTrigger>
            ...
            <Collapsible>
              <CollapsibleTrigger className="flex items-center justify-between w-full">
                <h2 className="text-3xl font-display font-semibold text-center">Our Promise to Business Owners</h2>
                <ChevronDown className="h-6 w-6 transition-transform duration-200 collapsible-open:rotate-180" />
              </CollapsibleTrigger>
              <CollapsibleContent className="pt-6">
